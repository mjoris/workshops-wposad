# Web Programming on Servers and Devices - workshop materials
...
```shell
git clone https://github.com/mjoris/workshops-wposad.git
```
* Open the file <code>workshops-wposad/app/html/index.html</code> in a browser
...
* Run from your terminal/cmd, in your <code>workshops-wposad</code> directory
```shell
git reset --hard
